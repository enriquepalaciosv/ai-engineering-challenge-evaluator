...
function App() {
  ...
  return <main className="shell">
    <header className="hero"><div><p className="eyebrow">AI Engineering Challenge</p><h1>Patterns, not rankings.</h1><p className="lede">Compare PR approaches, preserve what worked, identify unnecessary AI overhead, and build the next team workflow from evidence.</p></div><div className="hero-stat"><strong>{data.submissions.length}</strong><span>approaches analyzed</span></div></header>
